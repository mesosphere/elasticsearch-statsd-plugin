...
```
./bin/elasticsearch-plugin install https://github.com/Automattic/elasticsearch-statsd-plugin/releases/download/6.4.3.0/elasticsearch-statsd-6.4.3.0.zip
```

From Maven Central:
```
./bin/elasticsearch-plugin install http://repo1.maven.org/maven2/com/automattic/elasticsearch-statsd/6.4.3.0/elasticsearch-statsd-6.4.3.0.zip
```
...
```
bin/elasticsearch-plugin install file:///absolute/path/to/current/dir/target/releases/elasticsearch-statsd-6.4.2.0.zip
```
